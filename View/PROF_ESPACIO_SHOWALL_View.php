...
?>
			...
			<br>
			<br>
			<a href='../Controller/PROF_ESPACIO_Controller.php?action=ADD'><img src='../View/icons/add.png'></a>
			<tab>
			<a href='../Controller/PROF_ESPACIO_Controller.php?action=SEARCH'><img src='../View/icons/search.png'></a>
			<br>
			<br>
		<table>
			<tr>

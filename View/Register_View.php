...
//Creado por: 	dcquf1
//Descripcion: vista del registro
//-------------------------------------------------------
	...
	class Register{
		...
		?>
			...
			<form class="formulario" enctype="multipart/form-data" name = 'Form' action='../Controller/Register_Controller.php' method='post' onsubmit="return comprobar_registro();">
					...
					<span key="Foto personal" class="translate"></span><?php //echo $strings['FotoPersonal']?> :<br> <input type = 'file' name = 'fotopersonal' id = 'fotopersonal' placeholder = '' size = '50' value = '' onblur="esNoVacio('fotopersonal')" required><br><br>
			...
			<br><a href='../Controller/Index_Controller.php'><img src='../View/icons/back.png'> </a>

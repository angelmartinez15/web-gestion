...
//Clase : USUARIOS_SHOWCURRENT_View
	...
	class USUARIOS_SHOWCURRENT{
		...
		?>
			...
			<form class="formulario" enctype="multipart/form-data" name = 'Form' action='../Controller/USUARIOS_Controller.php' method='post' onsubmit="return comprobar_registro();">
				 	...
				 	Login : <input type = 'text' name = 'login' id = 'login' size = '15' value = '<?php echo $this->tupla['login']; ?>' readonly><br>

					Password : <input type = 'password' name = 'password' id = 'password' size = '128' value = '<?php echo $this->tupla['password']; ?>' readonly><br>

					DNI : <input type = 'text' name = 'DNI' id = 'DNI' size = '9' value = '<?php echo $this->tupla['DNI']; ?>' readonly><br>
			...
			<a href='../Controller/USUARIOS_Controller.php'><img src='../View/icons/back.png'> </a>
